...
using Nop.Plugin.Misc.FraudLabsPro.Components;
...
namespace Nop.Plugin.Misc.FraudLabsPro
{
    ...
    /// </summary>
    public class FraudLabsProPlugin : BasePlugin, IWidgetPlugin
    {
        #region Fields
        ...
        public Type GetWidgetViewComponent(string widgetZone)
        {
            ...
            {
                return typeof(FraudLabsProViewComponent);
            }
            else
            {
                return typeof(FraudLabsProOrderViewComponent);
            }
        }
